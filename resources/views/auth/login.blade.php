...
<div class="container">
    <div class="flex justify-center">
        <div class="columns-2xl">
            <div class="card">
                <div class="card-header bg-sky-800 text-white">{{ __('Login') }}</div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                    <input class="form-check-input checked:bg-sky-800 checked:border-sky-800" type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}>
